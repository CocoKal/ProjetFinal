...
--
 ...
 CREATE TABLE hotel (hotel_id_hotel INT(10) AUTO_INCREMENT NOT NULL,
  hotel_name_hotel VARCHAR(20), hotel_localisation_hotel VARCHAR(20),
   PRIMARY KEY (hotel_id_hotel)) ENGINE=InnoDB;


   DROP TABLE IF EXISTS is_booked ;
   CREATE TABLE is_booked (room_id_room **NOT FOUND**(10) AUTO_INCREMENT NOT NULL,
    booking_id_booking **NOT FOUND**(10) NOT NULL,
    PRIMARY KEY (room_id_room,  booking_id_booking)) ENGINE=InnoDB;
...
ALTER TABLE `staff`
  ...
  ALTER TABLE room
   ADD CONSTRAINT FK_room_hotel_id_hotel FOREIGN KEY (hotel_id_hotel) REFERENCES hotel (hotel_id_hotel);
   ALTER TABLE is_booked
   ADD CONSTRAINT FK_is_booked_room_id_room FOREIGN KEY (room_id_room) REFERENCES room (room_id_room);
   ADD CONSTRAINT FK_is_booked_booking_id_booking FOREIGN KEY (booking_id_booking) REFERENCES booking (booking_id_booking);
