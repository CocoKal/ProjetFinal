			...
			<div class="row about_row">
				...
				<div class="col-lg-6">
					<div class="about_images d-flex flex-row align-items-start justify-content-between flex-wrap">
						<img src="Content/Content/images/about_1.png" alt="">
						<img src="Content/Content/images/about_2.png" alt="">
			...
			<div class="row row-xl-eq-height">
				...
				<div class="col-xl-6 order-xl-1 order-2">
					<div class="split_section_image">
						<div class="background_image" style="background-image:url(Content/images/milestones.jpg)"></div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-xl-6">
					<div class="split_section_image split_section_left_image">
						<div class="background_image" style="background-image:url(Content/images/loaders.jpg)"></div>
					</div>
				</div>
				...
				<div class="row footer_row">
					...
					<div class="col-lg-3">
						<div class="certificates d-flex flex-row align-items-start justify-content-lg-between justify-content-start flex-lg-nowrap flex-wrap">
							<div class="cert"><img src="Content/images/cert_1.png" alt=""></div>
